...
export default function InvoiceDetailsPage() {
  ...
  const { data: invoiceDetails, isLoading } = api.invoices.invoiceById.useQuery(
    invoiceId,
    {
      enabled: !!invoiceId,
    }
  ...
  if (!invoiceDetails) {
    return <div className="p-8 flex justify-center">Invoice not found</div>;
  }

  const isInvoice = true;
  const entityName = "Invoice";
  const counterpartyLabel = "Customer";
  ...
  const transaction = invoiceDetails;
